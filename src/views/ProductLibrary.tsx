...
import { Plus, Edit2, Trash2, Search, Filter, Save, X, MoreHorizontal, Eye, Download, Upload, CheckSquare, Square, Trash, ChevronRight, ChevronDown, Folder, FolderOpen, ArrowUp, ArrowDown, ArrowUpDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">产品库管理</h2>
